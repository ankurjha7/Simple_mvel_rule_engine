...
public class RuleCompilationException extends RuntimeException {
     ...
     * @since 1.4
     */
    public RuleCompilationException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public RuleCompilationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
